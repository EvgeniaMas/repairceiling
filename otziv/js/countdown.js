function CDT(){
 ...
 // УКАЖИТЕ ДАТУ И ВРЕМЯ ДО КАКОГО ВАША АКЦИЯ
 var tl = new Date('2015/02/28 17:00:00');
 
 //-------------------------------------------------------------------------------------------------------	
 // НИЖЕ КОД МЕНЯТЬ И РЕДАКТИРОВАТЬ БЕЗ ЗНАНИЙ И НАВЫКОВ НЕ РЕКОМЕНДУЕТСЯ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 //-------------------------------------------------------------------------------------------------------
 
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">Завершено!</span></span>');
 timer.countDown();
}
